...
public class IsAbilitySlotFilledRequirement extends AbstractAbilitySlotRequirement {
    public IsAbilitySlotFilledRequirement() { super("visibility_requirement_is_ability_slot_filled"); }
    ...
    protected @NotNull String getLocalizationBase() {
        return "tensura_fancymenu.requirements.world.is_ability_slot_filled";
    }
}
