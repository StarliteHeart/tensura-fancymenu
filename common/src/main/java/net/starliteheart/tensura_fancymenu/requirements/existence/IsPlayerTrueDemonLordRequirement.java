...
public class IsPlayerTrueDemonLordRequirement extends AbstractTensuraRequirement {
    public IsPlayerTrueDemonLordRequirement() {
        super("is_player_true_demon_lord");
    }

    @Override
    protected boolean isTensuraRequirementMet(@NotNull LocalPlayer player, @NotNull ClientLevel level,
                                              @Nullable String value) {
        return TensuraStorages.getExistenceFrom(player).isTrueDemonLord();
    }
}
