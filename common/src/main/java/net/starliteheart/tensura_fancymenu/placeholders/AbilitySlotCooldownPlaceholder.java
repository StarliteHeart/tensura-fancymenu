...
public class AbilitySlotCooldownPlaceholder extends AbstractAbilitySlotPlaceholder {
    public AbilitySlotCooldownPlaceholder() {
        super("ability_slot_cooldown");
    }
    ...
    protected String getAbilityValue(@NotNull LocalPlayer player, @NotNull ClientLevel level,
        ...
        return (skill instanceof TensuraSkill tensuraSkill && tensuraSkill.getColoredName() != null)
                ? String.valueOf(instance.getCoolDown(ability.getMode()))
                : "0";
    }

    @Override
    protected @NotNull String getLocalizationBase() {
        return "tensura_fancymenu.placeholders.world.ability_slot_cooldown";
    }
}