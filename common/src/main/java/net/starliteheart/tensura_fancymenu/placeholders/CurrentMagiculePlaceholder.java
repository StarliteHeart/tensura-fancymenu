...
public class CurrentMagiculePlaceholder extends AbstractWorldFloatPlaceholder {
    public CurrentMagiculePlaceholder() {
        super("current_magicule");
    }
    ...
    protected @NotNull String getLocalizationBase() {
        return "tensura_fancymenu.placeholders.world.current_magicule";
    }
}