...
public class MaxMountSpiritualHealthPlaceholder extends AbstractWorldFloatPlaceholder {
    ...
    protected @NotNull String getLocalizationBase() {
        return "tensura_fancymenu.placeholders.world.max_mount_spiritual_health";
    }
}